...
public class ModificarEditorialDialog extends JDialog {
	...
	private void guardarCambios() {
		...
		boolean modificacionCorrecta = SistemaBDL.getInstance().getControlEditorial().modificarEditorial(id, nombre);

		if (modificacionCorrecta) {
			JOptionPane.showMessageDialog(this, "Editorial modificada correctamente.", "MODIFICACIÓN CORRECTA",
					JOptionPane.INFORMATION_MESSAGE);
			dispose();
		} else {
			JOptionPane.showMessageDialog(this, "No se ha podido modificar la editorial.", "ERROR MODIFICACIÓN",
