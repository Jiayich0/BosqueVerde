    ...
    private void darBaja() {
        ...
        if (id.isEmpty()) {
            JOptionPane.showMessageDialog(this, 
                ...
                "DATOS NO VÁLIDOS - BAJA EDITORIAL", 
        ...
        if (editorial == null) {
            JOptionPane.showMessageDialog(this, 
                "No se ha podido dar de baja. No existe una editorial con ese ID.",
        ...
        if (!editorial.isActivo()) {
            JOptionPane.showMessageDialog(this, 
                "La editorial ya está dada de baja.",
                "EDITORIAL YA INACTIVA", 
        ...
        if (tieneLibros) {
            JOptionPane.showMessageDialog(this, 
                "No se puede dar de baja la editorial porque tiene libros asociados.",
                "ERROR - LIBROS ASOCIADOS", 
                JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (bajaCorrecta) {
            JOptionPane.showMessageDialog(this, 
                "Editorial dada de baja correctamente.",
                "BAJA CORRECTA", 
                JOptionPane.INFORMATION_MESSAGE);
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, 
                "No se ha podido dar de baja la editorial.",
                "ERROR BAJA", 
                JOptionPane.ERROR_MESSAGE);
        }
    }
