...
public class DarBajaSocioDialog extends JDialog {
	...
	private void darBaja() {
		...
		Socio socio = SistemaBDL.getInstance().getControlCliente().leerSocio(dniCliente);
		...
		boolean bajaCorrecta = SistemaBDL.getInstance().getControlCliente().darBajaSocio(dniCliente);
