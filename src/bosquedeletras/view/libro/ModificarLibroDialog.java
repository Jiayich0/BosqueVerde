...
public class ModificarLibroDialog extends JDialog {
	...
	private void guardarCambios() {
		...
		boolean modificacionCorrecta = SistemaBDL.getInstance().getControlLibro().modificarLibro(titulo, autor, isbn,
				editorial, ano);
		...
		if (modificacionCorrecta) {
			...
			JOptionPane.showMessageDialog(this, "No se ha podido modificar el libro.", "ERROR MODIFICACIÓN",
					JOptionPane.ERROR_MESSAGE);
		}
	}
}